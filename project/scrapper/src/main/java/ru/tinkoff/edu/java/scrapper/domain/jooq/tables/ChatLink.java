...
public class ChatLink extends TableImpl<ChatLinkRecord> {
    ...
    /**
     * The column <code>public.chat_link.link_url</code>.
     */
    public final TableField<ChatLinkRecord, String> LINK_URL = createField(DSL.name("link_url"), SQLDataType.VARCHAR(2048).nullable(false), this, "");
    ...
    public List<ForeignKey<ChatLinkRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CHAT_LINK__CHAT_LINK_CHAT_ID_FKEY, Keys.CHAT_LINK__CHAT_LINK_LINK_URL_FKEY);
    }
    ...
    public Link link() {
        if (_link == null)
            _link = new Link(this, Keys.CHAT_LINK__CHAT_LINK_LINK_URL_FKEY);
