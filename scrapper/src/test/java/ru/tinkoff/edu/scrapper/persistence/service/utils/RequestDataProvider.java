...
public final class RequestDataProvider {

    private RequestDataProvider() {
    }

    public static final String TEST_URL =
        "https://github.com/vbandurin7/Tinkoff-Homeworks/pull/5/commits/43b784c661bab3937730d3671c721f074c0b0cb2";
    public static final Map<String, String> LINK_INFO = Map.of(
            "username", "vbandurin7",
            "repository", "Tinkoff-Homeworks"
    );
    public static final String TEST_URL_2 =
        "https://stackoverflow.com/questions/76051046/what-should-i-do-to-load-all-mpnet-base-v2-model-from-sentence-transformers";
    ...
    public static final String COUNT_CHAT_LINK_SQL =
        "SELECT count(*) FROM chat_link WHERE link_url = ? AND chat_id = ?";
