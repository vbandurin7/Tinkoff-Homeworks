...
public class Keys {
    ...
    public static final UniqueKey<ChatLinkRecord> CHAT_LINK_PKEY = Internal.createUniqueKey(ChatLink.CHAT_LINK, DSL.name("chat_link_pkey"), new TableField[] { ChatLink.CHAT_LINK.CHAT_ID, ChatLink.CHAT_LINK.LINK_URL }, true);
    ...
    public static final ForeignKey<ChatLinkRecord, LinkRecord> CHAT_LINK__CHAT_LINK_LINK_URL_FKEY = Internal.createForeignKey(ChatLink.CHAT_LINK, DSL.name("chat_link_link_url_fkey"), new TableField[] { ChatLink.CHAT_LINK.LINK_URL }, Keys.LINK_URL_KEY, new TableField[] { Link.LINK.URL }, true);
}
